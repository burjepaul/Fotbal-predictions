    ...
    return (
        ...
        <div className='image-container'>
            ...
            <div className='image-text'>
                <p>We are trying to predict the fotbal matches results using an automate software. The automation is done by scanning all the fotbal matches that are going to be 
